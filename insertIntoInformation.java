...
public class insertIntoInformation {
    ...
    */
    ...
    public insertIntoInformation(String sql) {
        try {
            //1.注册驱动
            Class.forName(DBDRIVER);
            //2.获取连接
            ...
            Statement stmt = conn.createStatement();
            //4.准备sql语句
            //String thisSql = "CREATE TABLE student02(s_id INT PRIMARY KEY,s_name VARCHAR(20),s_age INT)";
            // 5.通过statement对象发送sql语句,返回执行结果
        ...
        //stmt.executeUpdate(sql);
        lp_domon.palySQLIntructionsForInsetInformation() ;
